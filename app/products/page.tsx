...
const products = [
  {
    title: 'Entry Point',
    subtitle: 'Stație de intrare',
    href: '/products/entry-point',
    image: '/img/produs1.png',
    icon: <LuLogIn className="w-6 h-6 text-green-600" />,
    desc: 'Stație inteligentă pentru controlul accesului în parcări moderne.',
    features: [
      'Emitere card acces',
      'Citire NFC',
      'Citire QR Code',
  ...
  {
    title: 'Pay Point',
    subtitle: 'Terminal de plată',
    href: '/products/pay-point',
    image: '/img/produs3.png',
    icon: <LuCreditCard className="w-6 h-6 text-green-600" />,
    desc: 'Terminal de plată automat cu suport numerar și card.',
    features: [
      'Plăți cu card',
      'Plăți numerar',
      'Rest automat',
      'Bon fiscal',
      'NFC / QR Code',
      'Raportări și reconciliere',
    ],
  },
  {
    title: 'BackOffice',
    subtitle: 'Platformă software',
    href: '/products/backoffice',
    image: null,
    icon: <LuLayoutDashboard className="w-6 h-6 text-green-600" />,
    desc: 'Platformă software pentru administrarea tuturor locațiilor.',
    features: [
      'Dashboard & rapoarte',
...
const whyUs = [
  { title: 'Soluții complete hardware & software', icon: <LuShieldCheck className="w-6 h-6 text-green-600" /> },
  { title: 'Integrare ușoară', icon: <LuPuzzle className="w-6 h-6 text-green-600" /> },
  { title: 'Suport tehnic local', icon: <LuSettings2 className="w-6 h-6 text-green-600" /> },
  { title: 'Actualizări continue', icon: <LuZap className="w-6 h-6 text-green-600" /> },
  { title: 'Rapoarte avansate în timp real', icon: <LuLayoutDashboard className="w-6 h-6 text-green-600" /> },
  { title: 'Securitate ridicată', icon: <LuShieldCheck className="w-6 h-6 text-green-600" /> },
];
          ...
          <div className="relative lg:absolute inset-0 z-10 flex flex-col justify-start pt-32 sm:pt-36 lg:pt-52 pb-12 px-6 lg:pl-24">
            <div className="max-w-xl">
              ...
              <p data-reveal data-reveal-delay="250" className="text-gray-600 text-lg leading-relaxed max-w-xl mb-8">
                Soluții hardware și software dezvoltate pentru automatizarea completă a parcărilor moderne.
              </p>

              <div data-reveal data-reveal-delay="340" className="grid grid-cols-3 gap-6 max-w-sm mb-8">
                {[
                  { label: 'Hardware propriu' },
                  { label: 'Software propriu' },
                  { label: 'Suport tehnic local' },
                ].map((b) => (
        ...
        <div className="max-w-screen-xl mx-auto px-6 lg:px-10">
          <div data-reveal="fade" className="text-center mb-14">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-3">
              Soluții complete pentru fiecare etapă a parcării
            </h2>
            <p className="text-gray-500 text-base max-w-2xl mx-auto">
              Echipamente și software integrate pentru un flux de parcare eficient, sigur și automatizat.
            </p>
          </div>
              ...
              >
                ...
                <div className="flex flex-col flex-1 p-5">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-xs text-gray-400 font-semibold uppercase tracking-wide">{p.subtitle}</span>
                  </div>
        ...
        <div className="max-w-screen-xl mx-auto px-6 lg:px-10">
          <div data-reveal="fade" className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-3">
              De ce să alegi <span className="text-green-600">RParking</span>?
            </h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6">
            {whyUs.map((w, idx) => (
              ...
              >
                ...
                <span className="text-gray-700 text-xs font-semibold leading-tight">{w.title}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-10 text-center">
          <h2 data-reveal className="text-3xl md:text-4xl font-black text-white mb-4 leading-tight">
            Doriți o soluție completă<br />pentru parcarea dvs.?
          </h2>
