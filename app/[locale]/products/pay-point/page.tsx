...
const keyFeatures = [
  ...
  { key: 'k2', icon: <LuBanknote className="w-6 h-6 text-green-600" /> },
  { key: 'k3', icon: <LuCoins className="w-6 h-6 text-green-600" /> },
  { key: 'k4', icon: <LuReceipt className="w-6 h-6 text-green-600" /> },
  { key: 'k5', icon: <LuQrCode className="w-6 h-6 text-green-600" /> },
  { key: 'k6', icon: <LuRadioTower className="w-6 h-6 text-green-600" /> },
];

const steps = [
  { key: 's1', icon: <LuPointer className="w-16 h-16 text-green-600" /> },
  { key: 's2', icon: <LuCreditCard className="w-16 h-16 text-green-600" /> },
  { key: 's3', icon: <LuShieldCheck className="w-16 h-16 text-green-600" /> },
  { key: 's4', icon: <LuReceipt className="w-16 h-16 text-green-600" /> },
...
const specs = [
  ...
  { key: 'sp2', icon: <LuCreditCard className="w-4 h-4 text-gray-400" /> },
  { key: 'sp3', icon: <LuRadioTower className="w-4 h-4 text-gray-400" /> },
  { key: 'sp4', icon: <LuQrCode className="w-4 h-4 text-gray-400" /> },
  { key: 'sp5', icon: <LuPrinter className="w-4 h-4 text-gray-400" /> },
  { key: 'sp6', icon: <LuBanknote className="w-4 h-4 text-gray-400" /> },
  { key: 'sp7', icon: <LuCoins className="w-4 h-4 text-gray-400" /> },
  { key: 'sp8', icon: <LuReceipt className="w-4 h-4 text-gray-400" /> },
  { key: 'sp9', icon: <LuWifi className="w-4 h-4 text-gray-400" /> },
...
const integrations = [
  ...
  { key: 'i3', icon: <LuLayoutDashboard className="w-7 h-7 text-green-600" /> },
  { key: 'i4', icon: <TbBarrierBlock className="w-7 h-7 text-green-600" /> },
  { key: 'i5', icon: <LuCamera className="w-7 h-7 text-green-600" /> },
  { key: 'i6', icon: <LuSmartphone className="w-7 h-7 text-green-600" /> },
  { key: 'i7', icon: <LuCreditCard className="w-7 h-7 text-green-600" /> },
...
export default async function PayPointPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const t = await getTranslations('PayPointPage');
  return (
    <main>
      {/* Navbar + Logo */}
        ...
        <div className="max-w-screen-2xl mx-auto px-6 lg:px-10">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-stretch">
            ...
            <div data-reveal="fade-left" className="bg-white rounded-2xl p-4 flex items-center justify-center border border-gray-100">
              <Image src="/img/produse/pay point.jpg" alt="Pay Point componente" width={600} height={800} className="w-full lg:w-auto lg:h-[480px] max-h-[70vw] lg:max-h-none object-contain" />
            </div>
