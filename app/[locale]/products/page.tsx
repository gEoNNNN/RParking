...
export const metadata: Metadata = {
  title: 'Produse RParking – Echipamente Parcare Automatizată Moldova',
  description:
    'Echipamente complete pentru automatizarea parcărilor în Moldova: Entry Point (intrare), Exit Point (ieșire), Pay Point (plată), BackOffice (software), RAccess WC, RChange. Hardware și software produs în Republica Moldova.',
  keywords: [
    'echipamente parcare Moldova',
    'echipament parcare Chișinău',
    'sistem automatizare parcare Moldova',
    'terminal intrare parcare Moldova',
    'terminal iesire parcare Moldova',
    'terminal plata parcare Moldova',
    'aparat parcare Moldova',
    'software management parcare Moldova',
    'bariere automate parcare Moldova',
    'control acces parcare Moldova',
    'Entry Point parcare Moldova',
    'Exit Point parcare Moldova',
    'Pay Point parcare Moldova',
    'BackOffice parcare Moldova',
    'RAccess WC Moldova',
    'RChange Moldova',
    'schimb valutar automat Chișinău',
    'statie parcare automata Moldova',
    'RParking produse',
    'cumpar echipamente parcare Moldova',
  ],
  alternates: {
    canonical: '/products',
  },
