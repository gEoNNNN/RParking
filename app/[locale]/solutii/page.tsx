...
export const metadata: Metadata = {
  ...
  keywords: [
    'solutii parcare',
    'solutii automatizare parcare',
    'sistem parcare centre comerciale',
    'automatizare parcare centre comerciale',
    'sistem parcare business centre',
    'parcare rezidentiala automatizata',
    'parcare aeroport sistem',
    'parcare institutii publice',
    'parcare hotel sistem',
    'parcare spital sistem',
    'echipament parcare',
